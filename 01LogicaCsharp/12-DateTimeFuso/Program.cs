...
namespace _12_DateTimeFuso
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Padrão ISO 8602   yyy-MM-ddTHH:mm:ssZ (Z indica que a data/hora está em Utc)
            DateTime d4 = DateTime.Parse("2000-08-15 13:05:58");
            DateTime d5 = DateTime.Parse("2000-08-15T13:05:58Z"); // armazenada no formato Utc, instanciada no formato Local
